                ...
                button2.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if(er.equals(false))
                        {
                            ...
                            ProgressBar progressBar2=findViewById(R.id.Progresshrate);
                            TextView textView2=findViewById(R.id.txthrate);
                            progressBar1.setProgress(hrateint);
                            textView2.setText(heartrate);
