...
public class UnitTest {
    ...
    /**
     * testing editData method for exceptions
     */
    @Test
    public void testEditRecordException() {
        Date date = Calendar.getInstance().getTime();
        ...
        // Edit the existing data with a different ID
        AddNewData editedData = new AddNewData(80, 140, 67, "Id2", "Edited Comment1", date);

        assertThrows(IllegalArgumentException.class, () -> dataList.editData(editedData));
    }
}
