...
public class SignUpActUITest {
    ...
    @Test
    public void testSignUpAct() throws InterruptedException {
        ...
        onView(withId(R.id.name)).perform(typeText("Soummo"));
        onView(withId(R.id.SignUpEmail)).perform(typeText("uuuvi@gmail.com"));
